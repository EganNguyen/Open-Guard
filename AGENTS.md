...
This project is indexed by GitNexus as **Open-Guard** (7410 symbols, 11901 relationships, 267 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
