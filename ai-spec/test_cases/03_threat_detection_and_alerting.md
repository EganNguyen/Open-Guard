...
- **System Verifications:** Kafka `auth.login_failed` -> Threat detector -> MongoDB insertion.

### TC-THR-002: Impossible Travel Detection
- **Steps:** Login from NYC, then from Tokyo 5 mins later.
- **System Verifications:** Haversine distance calculation (> 500km) + Time delta check.
