...
SELECT 'CREATE DATABASE openguard_iam'
WHERE NOT EXISTS (
    SELECT FROM pg_database
    WHERE datname = 'openguard_iam'
) \gexec
SELECT 'CREATE DATABASE openguard_policy'
WHERE NOT EXISTS (
    SELECT FROM pg_database
    WHERE datname = 'openguard_policy'
) \gexec
SELECT 'CREATE DATABASE openguard_dlp'
WHERE NOT EXISTS (
    SELECT FROM pg_database
    WHERE datname = 'openguard_dlp'
) \gexec
