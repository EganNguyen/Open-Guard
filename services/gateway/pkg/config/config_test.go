...
func TestLoad(t *testing.T) {
	...
	os.Setenv("GATEWAY_JWT_KEYS_JSON", `[{"kid":"k1","secret":"s1","algorithm":"HS256","status":"active"}]`)
	os.Setenv("GATEWAY_JWT_EXPIRY", "7200")
	...
	defer func() {
		...
		os.Unsetenv("GATEWAY_JWT_KEYS_JSON")
		os.Unsetenv("GATEWAY_JWT_EXPIRY")
...
func TestLoad_Defaults(t *testing.T) {
	...
	os.Setenv("GATEWAY_JWT_KEYS_JSON", "[]")
	defer os.Unsetenv("GATEWAY_JWT_KEYS_JSON")
